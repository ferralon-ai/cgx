...
| 02 | [02-personas-and-questions.md](02-personas-and-questions.md) | Persona-driven question inventory: 126 questions across 12 themes, 104 NOVEL; four personas (PSE, SSE, ACA, ASA); all four canonical prompt examples; Theme 10 covers concurrency and resource safety; Theme 11 covers types, mutability, and closures; Theme 12 covers framework semantics and metadata |
...
| — | [questions/README.md](questions/README.md) | Index of the 12 question-cookbook theme files (126 questions total): file names, themes, question ID ranges, and counts; plus an explanation of the entry template (how to read personas/status/query/breakdown/result sections) and pointers to docs/13 and docs/05 |
